...
For further consultation or a request of this code and future code, please contact with *matthew.lc.zheng@outlook.com*(worldwdie). All informal conversations are suggested being done by *zsms123zlc@gmail.com*(international user) or *libraneptune@163.com*(domeestic user)
...
```
This code is based on the release of detectron2 from FAIR, an excellent toolkit for detection. That means detectron2 is supposed to be installed as well. For the detail of setup, please refer to the project of detectron2.
